...
const nuevaString = "gracias Henry por la oportunidad";
...
function elevar(num, exponent) {
  ...
  // Tu código:
  numAlExponente = Math.pow(num,exponent)
  return numAlExponente;
}
...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var conExclamacionAgregado = str + '!';
  return conExclamacionAgregado;
}
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  var dolaresPorEuros = (euro * 1.20)/1;
  return dolaresPorEuros;
}
